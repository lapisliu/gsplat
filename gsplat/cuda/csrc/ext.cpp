...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("fused_adam_init", &gsplat::fused_adam_init);
    m.def("fused_adam_free", &gsplat::fused_adam_free);
    m.def("customized_fused_adam_update", &gsplat::customized_fused_adam_update);
}
